...
/*bool RenderLayer::GetEnableColorCorrection() const {
	if (_renderFlags == EnableColorCorrection) {
		return 1;
	}
	return 0;
}
bool RenderLayer::GetEnableWarm() const {
	if (_renderFlags == EnableWarm) {
		return 1;
	}
	return 0;
}
bool RenderLayer::GetEnableCold() const {
	if (_renderFlags == EnableCold) {
		return 1;
	}
	return 0;
}
bool RenderLayer::GetEnableDumpster() const {
	if (_renderFlags == EnableDumpster) {
		return 1;
	}
	return 0;
}*/
